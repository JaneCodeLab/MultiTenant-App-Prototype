    ...
    function Node(data) {
        ...
        this.formatNode = function (opts) {
            ...
            if (typeof data.name !== 'undefined') {
                nameString += `<div class="card card-widget widget-user">
                                  <div class="widget-user-header text-white bg-dark-info">
                                    <h5 class="widget-user-username">` + self.data.name + `</h5>
                                    <p class="widget-user-desc">` + self.data.role + `</p>
                                  </div>
                                  <div class="widget-user-image">
                                    <img class="img-circle elevation-2" src="` + self.data.description + `" alt="` + self.data.name + `">
                                  </div>
            ...
            //    if (self.data.btn1 != '') {
            //        buttonsHtml += self.data.btn1;
            //    }
            //    if (self.data.btn2 != '') {
            //        buttonsHtml += self.data.btn2;
            //    }
            //    if (self.data.btn3 != '') {
            //        buttonsHtml += self.data.btn3;
            //    }
            //}
            //else {
            //    buttonsHtml = '';
